...
window.TUNING = {
    ...
    redClusterImpulseScale: 0.08,
    redClusterTorqueScale: 0.025,
    redClusterLinearDrag: 2.2,
    redClusterAngularDrag: 5.4,
    redClusterAlignStrength: 10,
    redClusterPoseBlend: 18,
    redClusterPoseDecay: 10,
    redClusterPoseScale: 1.0,
    redClusterPoseTargetBlend: 0.72,
    redClusterPoseMaxOffset: 180,
...
const TUNING_DEFS = [
    ...
    { section: '红架构 transport / posture', sectionDesc: '红色节点组不再靠内部弹簧互掐，而是由组体运输层和局部姿态层协同驱动。' },
    { key: 'redClusterImpulseScale', label: '组体推进缩放', desc: '红节点语义脉冲转成 cluster 线速度的比例。', min: 0.01, max: 0.4, step: 0.01 },
    { key: 'redClusterTorqueScale', label: '组体扭矩缩放', desc: '红节点命中点对 cluster 旋转的影响。', min: 0.001, max: 0.1, step: 0.001 },
    { key: 'redClusterLinearDrag', label: '组体线性阻尼', desc: '红结构整体平移的速度衰减。', min: 0, max: 12, step: 0.1 },
    { key: 'redClusterAngularDrag', label: '组体角阻尼', desc: '红结构整体旋转的速度衰减。', min: 0, max: 16, step: 0.1 },
    { key: 'redClusterAlignStrength', label: '组体朝向跟随', desc: '红结构整体朝当前 flow 纠正的力度。', min: 0, max: 30, step: 0.5 },
    { key: 'redClusterPoseBlend', label: '姿态跟随速率', desc: '红节点局部姿态偏移贴近目标的速度。', min: 1, max: 40, step: 1 },
    { key: 'redClusterPoseDecay', label: '姿态回正速率', desc: '红节点局部姿态回落到基础形状的速度。', min: 1, max: 40, step: 1 },
    { key: 'redClusterPoseScale', label: '姿态幅度缩放', desc: '红节点语义转换为局部姿态时的整体幅度。', min: 0.1, max: 2.5, step: 0.05 },
    { key: 'redClusterPoseTargetBlend', label: '姿态写入权重', desc: '一次脉冲把目标姿态写进 cluster posture 的比例。', min: 0.05, max: 1, step: 0.01 },
    { key: 'redClusterPoseMaxOffset', label: '姿态最大偏移', desc: '限制红节点局部姿态偏离基础骨架的上限。', min: 20, max: 400, step: 5 },
